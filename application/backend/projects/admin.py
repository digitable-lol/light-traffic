...
class ProjectAdmin(admin.ModelAdmin):
    fields = ('project_name','project_description','project_start_time','project_end_time','employee')
...
class ReportAdmin(admin.ModelAdmin):
    fields = ('report_name','report_creater','report_start','related_project','report_finish','report_green_comment','report_yellow_comment','report_red_comment','employee_going_vacation',
              'anyone_going_vacation','other_comments','final_report_color')
...
class ObjectiveAdmin(admin.ModelAdmin):
    fields = ('objective_name',"objective_descripion",'related_report','objective_color')
